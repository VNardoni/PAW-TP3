...
function generarJuego1() {
    limpiarTablero();
    Juego.enJuego = true;
    document.getElementById('muestraMensaje').removeAttribute('hidden');
    var divMm = document.getElementById('muestraMensaje');
    var elParrafo = divMm.firstElementChild;
    elParrafo.innerHTML = "Dificultad: Principiante";
    cargarTablero();
